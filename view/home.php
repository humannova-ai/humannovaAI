<?php
// Replace home page: redirect to login interface
session_start();
...
?>
    ...
    <section class="philosophy-section" id="about">
        <div class="philosophy-container">
            ...
            <h2 class="philosophy-headline">
                ...
                At PRO MANAGE AI, we transform complex challenges into elegant solutions through the convergence of 
    ...
    <section class="contact-section" id="contact">
        ...
        <div class="contact-container">
            <div class="contact-info">
                ...
                <a href="mailto:promanageai@gmail.com" class="info-item">
                    <div class="info-icon">📧</div>
                    <div class="info-text">
                        <h4>Email</h4>
                        <p>promanageai@gmail.com</p>
                    </div>
                </a>
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
                <div class="copyright">
                &copy; 2026 PRO MANAGE AI. All rights reserved.
            </div>

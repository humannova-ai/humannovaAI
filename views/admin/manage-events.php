...
<head>
    ...
    <style>
        ...
        * {
        ...
        .message.error {
            background: linear-gradient(135deg, rgba(255, 51, 51, 0.15), rgba(255, 100, 100, 0.1));
        ...
        .question-block {
            background: linear-gradient(135deg, var(--carbon-dark), rgba(153, 69, 255, 0.05));
...
<body>
        ...
        <div class="sidebar-section">
            ...
            <ul class="sidebar-menu">
                <li><a href="dashboard.php" class="sidebar-link">
                        <div class="sidebar-icon">📊</div><span>Dashboard</span>
                    </a></li>
                <li><a href="manage-events.php" class="sidebar-link <?php echo empty($filterType) ? 'active' : ''; ?>">
                        <div class="sidebar-icon">📅</div><span>Événements</span>
                    </a></li>
                <li><a href="manage-events.php?type=quiz"
                        class="sidebar-link <?php echo $filterType === 'quiz' ? 'active' : ''; ?>">
                        <div class="sidebar-icon">🎯</div><span>Quiz</span>
                    </a></li>
                <li><a href="manage-participations.php" class="sidebar-link">
                        <div class="sidebar-icon">👥</div><span>Participations</span>
                    </a></li>
            </ul>
        </div>
        <div class="sidebar-section">
            ...
            <ul class="sidebar-menu">
                <li><a href="../front/events.php" class="sidebar-link">
                        <div class="sidebar-icon">🌐</div><span>Front Office</span>
                    </a></li>
            </ul>
        </div>
    </aside>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <p class="page-subtitle">Créez, modifiez ou supprimez vos
                <?php echo $filterType === 'quiz' ? 'quiz' : 'événements'; ?></p>
        </div>
        ...
        <button class="btn btn-add" onclick="openAddModal()">➕ Ajouter un
            <?php echo $filterType === 'quiz' ? 'quiz' : 'événement'; ?></button>

        <div class="events-grid">
            <?php if (empty($events)): ?>
                <p style="color: var(--text-secondary); grid-column: 1/-1; text-align: center;">Aucun
                    <?php echo $filterType === 'quiz' ? 'quiz' : 'événement'; ?>.</p>
            <?php else: ?>
                <?php foreach ($events as $event): ?>
                    <div class="event-card">
                        <div class="card-image">
                            <img src="<?php echo getImagePath($event['image_url']); ?>"
                                alt="<?php echo htmlspecialchars($event['titre']); ?>"
                                onerror="this.src='https://via.placeholder.com/600x400/1a1a1a/00ffff?text=Event'">
                            <span
                                class="card-badge <?php echo $event['type'] === 'quiz' ? 'badge-quiz' : 'badge-normal'; ?>"><?php echo $event['type'] === 'quiz' ? '🎯 Quiz' : '📅 Normal'; ?></span>
                        </div>
                        <div class="card-content">
                            <h3 class="card-title"><?php echo htmlspecialchars($event['titre']); ?></h3>
                            <p class="card-description"><?php echo htmlspecialchars(substr($event['description'], 0, 70)); ?>...
                            </p>
                            ...
                            <?php if ($event['type'] === 'quiz'): ?>
                                <p style="color: var(--accent-purple); font-size: 12px; margin-top: 8px;">❓
                                    <?php echo $event['nombre_questions'] ?? 0; ?> question(s)</p>
                            <?php endif; ?>
                            <div class="card-actions">
                                <button class="btn btn-primary" onclick="openEditModal(<?php echo $event['id']; ?>)">✏️
                                    Modifier</button>
                                <button class="btn btn-danger"
                                    onclick="showDeleteConfirm(<?php echo $event['id']; ?>, '<?php echo htmlspecialchars(addslashes($event['titre'])); ?>')">🗑️
                                    Supprimer</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-box">
            ...
            <form method="POST" enctype="multipart/form-data" id="eventForm" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="titre" id="eventTitre" placeholder="Titre" maxlength="150"
                        oninput="filterTitreInput(this); validateTitre(this); updateCounter(this, 'titreCounter', 3)">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="eventDescription" placeholder="Description" maxlength="500"
                        rows="3" oninput="validateField(this, 10); updateCounter(this, 'descCounter', 10)"></textarea>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="date_debut" id="eventDateDebut"
                            onchange="validateField(this)">
                        <div class="validation-msg" id="date_debut-msg"></div>
                    </div>
                    <div class="form-group">
                        <label>Date de fin *</label>
                        <input type="datetime-local" name="date_fin" id="eventDateFin"
                            onchange="validateField(this); validateDates()">
                ...
                <div class="form-group">
                    ...
                    <div class="image-upload" id="imageUploadZone"
                        ...
                        <input type="file" name="image" id="imageInput" accept="image/*" style="display: none;"
                            onchange="previewImage(this); validateImage()">
                        <div>📷 Cliquez pour choisir une image</div>
                        <div style="color: var(--text-dim); font-size: 11px; margin-top: 5px;">JPG, PNG, GIF, WEBP (max
                            5MB)</div>
                ...
                <div id="quizSection" class="quiz-section" style="display: none;">
                    ...
                    <div class="quiz-config">
                        ...
                        <button type="button" class="btn btn-purple" onclick="genererQuestions()">🔄 GÉNÉRER LES
                            QUESTIONS</button>
                    </div>

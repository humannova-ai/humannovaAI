...
class Article {
    ...
    public function create($titre, $contenu, $excerpt = '', $image = '', $tags = '', $user_id = null) {
        try {
            ...
            $stmt = $this->conn->prepare("
                INSERT INTO {$this->table} (titre, contenu, excerpt, image, tags, user_id, date_creation) 
                VALUES (:titre, :contenu, :excerpt, :image, :tags, :user_id, NOW())
            ");
    ...
    public function update($id, $titre, $contenu, $excerpt = '', $image = '', $tags = '', $statut = null) {
        try {
            $stmt = $this->conn->prepare("
                UPDATE {$this->table} 
                SET titre = :titre, 
